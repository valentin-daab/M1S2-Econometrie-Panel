...
De manière générale, ces hypothèses sont vérifiées empiriquement dans la littérature qui porte sur l'appréciation des biens immobilier. Les sensibilités à ces facteurs sont variables, et dans de rares cas, les hypothèses sont rejetées. Ces différences sont expliquées par des caractéristiques locales qui varient selon les marchés (\cite{reichert1990impact}). En effet, la population ainsi que les revenus varient au niveau des États mais peuvent aussi varier localement dans les villes ou les quartiers. Un État rural aura donc des résultats qui diffèrent d'un État urbanisé, et au sein d'un état, les caractéristiques peuvent aussi varier localement. Cependant, pour la variable purement macroéconomique qu'est le taux d'intérêt réel des emprunts, la relation avec le prix est uniforme peu importe la localisation des biens immobiliers.

Les résultats qu'émettent la littérature sur ce sujet nous laissent donc penser que les variables ont des effets au sein d'un groupe (within), mais aussi entre différents groupes (between). Dans notre cas, nous souhaitons déterminer les déterminants qui impactent le prix de l'immobilier, 
